...
public:
	...
	//the keyword friend allows external functions to access members of ThreeD class.
	friend ostream& operator<<(ostream& str, const ThreeD& t);
};

int& ThreeD::operator[](int k) {//
	//Return by reference will return an object, rather than the value of an object. It will allow a
